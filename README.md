...
We then conducted A/B testing on several of the lowest-ranked field keys and their improved counterparts to assess the difference in LLM output quality. A licensed clinical social worker and a clinical therapist independently validated the outputs.
